...
public class MechanicalFluidExporterBlockEntity extends FluidTransactionKineticMachineBlockEntity implements IFluidExporterBlockEntity {
    ...
    public MechanicalFluidExporterBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntityReg.MECHANICAL_FLUID_EXPORTER.get(), pos, state);
    ...
    protected Component getDefaultName() {
        return Component.translatable("block.jackseconomy.mechanical_fluid_exporter");
    }
    ...
    public static void tick(Level level, BlockPos pos, BlockState state, MechanicalFluidExporterBlockEntity exporter) {
        exporter.tick();
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory inventory, Player player) {
        return new MechanicalFluidExporterMenu(containerId, inventory, this);
    }
