...
public abstract class FluidTransactionMachineMenu extends AbstractContainerMenu implements IBlockEntityContainer<FluidTransactionMachineBlockEntity> {
    private final FluidTransactionMachineBlockEntity blockEntity;

    protected FluidTransactionMachineMenu(@Nullable MenuType<?> pMenuType, int pContainerId, FluidTransactionMachineBlockEntity blockEntity) {
    ...
    public FluidTransactionMachineBlockEntity getBlockEntity() {
