...
public class Packets {
    ...
    public static void init() {
        ...
        INSTANCE.registerMessage(packetCount++,      ChangeImporterModePacket.class,      ChangeImporterModePacket::encode,      ChangeImporterModePacket::decode,      ChangeImporterModePacket::handle, Optional.of(NetworkDirection.PLAY_TO_SERVER));
        ...
        INSTANCE.registerMessage(packetCount++,        UpdateItemPricesPacket.class,        UpdateItemPricesPacket::encode,        UpdateItemPricesPacket::decode,        UpdateItemPricesPacket::handle, Optional.of(NetworkDirection.PLAY_TO_SERVER));
        INSTANCE.registerMessage(packetCount++,       UpdateFluidPricesPacket.class,       UpdateFluidPricesPacket::encode,       UpdateFluidPricesPacket::decode,       UpdateFluidPricesPacket::handle, Optional.of(NetworkDirection.PLAY_TO_SERVER));
        INSTANCE.registerMessage(packetCount++,      JeiInsertGhostItemPacket.class,      JeiInsertGhostItemPacket::encode,      JeiInsertGhostItemPacket::decode,      JeiInsertGhostItemPacket::handle, Optional.of(NetworkDirection.PLAY_TO_SERVER));
